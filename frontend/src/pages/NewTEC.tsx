...
const NewTEC: React.FC = () => {
  ...
  const createTEC = () => {
    ...
    // Create new TEC object
    const newTEC: TEC = {
      _id: `tec_${Date.now()}`, // Temporary ID for demo
      title: title.trim(),
    ...
    console.log("Creating TEC:", newTEC);
    
    // TODO: Call API to create TEC
    // apiService.createTec(accessToken, newTEC);
